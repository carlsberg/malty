...
describe('footer', () => {
  it('renders with brand info', () => {
    render(
      <Footer brandInfo="brand info" content={footerSections} socialMedia={socialMediaIcons} />
    );
  ...
  it('renders with copyright', () => {
    render(
      <Footer copyright="copyright" content={footerSections} socialMedia={socialMediaIcons} />
    );
  ...
  it('renders with socialmedia icon', () => {
    ...
    const socialIcon = screen.getByTestId(
      `footer-social-media-${FooterSocialMediaIconName.AppFacebook}`
    );
