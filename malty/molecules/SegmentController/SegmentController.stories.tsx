...
import {
  SegmentControllerOptions,
  SegmentControllerProps,
  SegmentControllerSize,
} from './SegmentController.types';
...
export default {
  ...
  argTypes: {
    ...
    selected: {
      description:
        'Segmented Control that is selected. Needs to match the value property inside options',
    },
    size: {
