...
import { WrappedIcon } from './Icon.wrapped';

function AddedDocument({ color, size, viewBox, onIconClick }: IconInterface) {
  const IconWrapped = WrappedIcon(
    { color, size, viewBox, onIconClick },
    <path
